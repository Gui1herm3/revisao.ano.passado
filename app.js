...
app.get('/dash', (req, res) => {
  ...
  res.redirect('/');
      ...
      // Rota para renderizar a página de postagens
app.get('/postagens', (req, res) => {
  // Supondo que postg seja um array de postagens que você recuperou do banco de dados
  const postg = [
      { id: 1, texto: "Conteúdo da postagem 1" },
      { id: 2, texto: "Conteúdo da postagem 2" },
      { id: 3, texto: "Conteúdo da postagem 3" }
  ];

  // Renderiza a página postagens.ejs e passa os dados das postagens
  res.render('postagens', { postg: postg });
});
